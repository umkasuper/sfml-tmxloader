...
namespace tmx
{
    ...
    */
    ...
    private:
        ...
        std::vector<std::unique_ptr<sf::Texture>> m_imageLayerTextures; // Текстуры слоев
        ...
        std::vector<LayerSet::TileInfo> m_tileInfo; //stores information on all the tilesets for creating vertex arrays
