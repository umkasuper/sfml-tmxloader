...
LayerSet::TileInfo::TileInfo()
        : m_type(LayerSet::TileType::Tile),
          TileSetId (0u),
          m_tileId(0u)
{
...
LayerSet::TileInfo::TileInfo(const sf::IntRect& rect, const sf::Vector2f& size, sf::Uint16 tilesetId, sf::Uint16 tileId, const std::vector<LayerSet::TileFrameDescription> &tileFrames)
        : m_type(LayerSet::TileType::Tile),
          Size		(size),
          TileSetId	(tilesetId),
          m_tileId    (tileId),
          m_tileFrames(tileFrames)
{
    ...
    m_type = m_tileFrames.empty() ? LayerSet::TileType::Tile : LayerSet::TileType::AnimationTile;
}
